...
1. Membuat Paragraf
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-04-03.png>))
...
2. Menambahkan Judul
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-07-35.png>))
...
3. Memformat Teks
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-11-15.png>))
...
4. Menyisipkan Gambar
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-29-46.png>))
...
5. Mengatur Ukuran Gambar
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-32-46.png>))
...
6. Menambahkan Hyperlink
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-39-02.png>))
...
7. Menambahkan List
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-39-02-1.png>))
...
8. Menambahkan Komentar
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-40-43.png>))
...
9. Menggabungkan Semua Elemen
    ...
    Screenshot:
    (![](<Screenshot from 2026-09-23 20-42-55.png>))